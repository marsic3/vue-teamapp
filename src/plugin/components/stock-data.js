...
let date1 = new Date('2012-04-02');
for (let i = 0; i < stockData1.length; i++) {
    // tslint:disable-next-line:no-string-literal
...
export let googl = stockData1;
let stockData2 = [{ x: new Date('2012-04-02'), close: 321.369812 },
...
for (let i = 0; i < stockData2.length; i++) {
    // tslint:disable-next-line:no-string-literal
...
let date3 = new Date('2012-04-02');
for (let i = 0; i < stockData3.length; i++) {
    // tslint:disable-next-line:no-string-literal
...
let date4 = new Date('2012-04-02');
for (let i = 0; i < stockData4.length; i++) {
    // tslint:disable-next-line:no-string-literal
